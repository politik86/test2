    ...
    if(((event.keyCode >= 48)&&(event.keyCode <= 57))||((event.keyCode >= 96)&&(event.keyCode <= 105))) {
        ...
        if(!isNaN(width) && !isNaN(height)) {
            ...
            ADAG.ajax({
               ...
               data: "type=flash&width="+ width +"&height=" + height + "&aid=" + aid,
			   async: false,
               success: function(msg){
				 ...
				 if(msg.length>=1 && msg != '<div class="ad-agency-content">'){
                    ...
                    for(var i=0;i<=splitEm.length-1;i++){
                        ...
                        campaigns += '<tr><td class="check_camp"><input type="checkbox" value="' + cmp[0] + '" name="adv_cmp['+ id +']" id="adv_cmp'+ id +'" class="formField camp' + cmp[0] + '"></td><td><label>' + zz[0] + '</label></td><td id="column'+(i+1)+'">'+availabe_zones+'</td><td class="check_ad" id="column_'+(i+1)+'">'+ selectbx +'</td></tr>';
						var availabe_zones = "";
                    }
    ...
    if ((pressbutton=='save')||(pressbutton=='apply')) {
        if (form['title'].value == "") {
            alert( "<?php echo JText::_("JS_INSERT_TITLE");?>" );
                ...
                return false;
            } /* else if (form['parameters[alt_text]'].value=="") {
                alert( "<?php echo JText::_("JS_BANNER_ALTTEXT"); ?>" );
            }*/ else {
