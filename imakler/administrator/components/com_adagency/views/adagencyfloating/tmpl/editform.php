...
<div class="row-fluid">
   <div class="span12 pull-right">
		...
		<a class="modal adagency-video-manager pull-right" rel="{handler: 'iframe', size: {x: 750, y: 435}}" href="index.php?option=com_adagency&controller=adagencyAbout&task=vimeo&id=69673989">
            <img src="<?php echo JURI::base(); ?>components/com_adagency/images/icon_video.gif" class="video_img" />
            <?php echo JText::_("COM_ADAGENCY_VIDEO_FLOATING_SETTINGS"); ?>   
        </a>
    </div>
</div>	
        ...
        <div class="tab-content">
			...
			<div class="tab-pane" id="advanced">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="formField"  type="text" name="width" size="3" value="<?php if ($_row->width!="") {echo $_row->width;} else {echo "";} ?>" /> x
						<input class="formField" type="text" name="height" size="3"	value="<?php if ($_row->height!="") {echo $_row->height;} else {echo "";} ?>" />
						&nbsp; 
				...
				<div class="control-group">
					<label class="control-label">
						<?php echo JText::_('AD_POS');?>
					</label>
					<div class="controls">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr><?php if(isset($_row->parameters["toppos"])||(isset($_row->parameters["bottpos"]))||(isset($_row->parameters["leftpos"]))||(isset($_row->parameters["rightpos"]))) { $ok=NULL; } else { $oktop=288; $okleft=459; }?>
								<td width="10%"><?php echo JText::_('AD_TOP')?></td>
								<td width="90%"><input class="formField" type="text" name="parameters[toppos]" size="8" value="<?php if (isset($_row->parameters["toppos"])) {echo $_row->parameters["toppos"];} else {echo $oktop;} ?>" />&nbsp; px</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td width="10%"><?php echo JText::_('AD_BOTTOM')?></td>
								<td>
								<input class="formField" type="text" name="parameters[bottpos]" size="8" value="<?php if (isset($_row->parameters["bottpos"])) {echo $_row->parameters["bottpos"];} else {echo "";} ?>" />&nbsp; px
								</td>
							</tr>
							<tr>
								<td width="10%"><?php echo JText::_('AD_LEFT')?></td>
								<td>
								<input class="formField" type="text" name="parameters[leftpos]" size="8" value="<?php if (isset($_row->parameters["leftpos"])) {echo $_row->parameters["leftpos"];} else {echo $okleft;} ?>" />&nbsp; px
								</td>
							</tr>
							<tr>
								<td width="10%"><?php echo JText::_('AD_RIGHT')?></td>
								<td>
								<input class="formField" type="text" name="parameters[rightpos]" size="8" value="<?php if (isset($_row->parameters["rightpos"])) {echo $_row->parameters["rightpos"];} else {echo "";} ?>" />&nbsp; px
								</td>
							</tr>
						</table>
						<div class="alert alert-notice">
							<p><?php echo JText::_('AD_FL_EXPL');?></p>
						</div>
					</div>
				</div>
