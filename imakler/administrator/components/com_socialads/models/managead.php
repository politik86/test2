...
class socialadsModelManageAd extends JModelLegacy
{
   var $_data;
	...
	function getAds($where='')
	{
		...
		{
			$ads->ad_impressions=$this->getImpCount($ads->ad_id);
			$ads->ad_clicks=$this->getClickCount($ads->ad_id);
		}


	/*print_r($myads);
	echo	$query = "SELECT campaign FROM #__ad_campaign WHERE camp_id=$myads->camp_id"; die();*/
