...
--
-- Table structure for table `#__ad_geo_country`
--
...
--
-- Dumping data for table `#__ad_geo_country`
--

INSERT INTO `#__ad_geo_country` (`country_id`, `country`, `country_3_code`, `country_code`, `country_jtext`) VALUES
