...
if($this->socialads_config['select_campaign']==0)
{
		...
		else
		{
			...
			//echo $myparam->name;
			//echo "=========";
			//print_r($socialads_config['gateways']);
			//echo "<br/>";
	...
	<fieldset class="sa_fieldset">
		...
		<div class="form-horizontal buildad_pricing_tab">
			...
			<div class="control-group">
				...
				<div class = "controls ">
					<?php echo JHTML::_('select.genericlist', $singleselect, "chargeoption", 'class="ad-pricing chzn-done" onchange="caltotal()" ', "value", "text", $ad_chargeoption);?>
		...
		<?php
			...
			?>
				...
				<div class="controls">
					<input type="text" maxlength="7" name="totaldisplay" class="ad-pricing input-medium cal_text" id="totaldisplay" value="<?php echo $ad_totaldisplay;?>" onchange="caltotal()"  />
				</div>
			</div>
		...
		<div class="control-group " >
			...
			<div class="">
				<label class="checkbox"><input type="checkbox" id="sa_coupon_chk" autocomplete="off" name="coupon_chk" value="" size="10" onchange="show_cop()"><?php echo JText::_("SA_DO_U_HV_A_COUPON") ?></label>
