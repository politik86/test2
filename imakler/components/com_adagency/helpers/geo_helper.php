...
<legend class="uk-margin-large-top">
  <?php echo JText::_('ADAG_GEO')." ".JText::_('ADG_OPTIONAL'); ?>
</legend>
...
<div class="uk-form-row">
  <label for="" class="uk-form-label">
    <input type="radio" align="absmiddle" name="geo_type" id="geo_type1" value="1" /><span class="uk-margin-left"><?php echo JText::_('ADAG_DELIVERY_LIM');?><span>
  </label>
  <div class="uk-form-controls">
    <select name="limitation" id="limitation" onchange="javascript:selim();">
    ...
    <div id="geo_container" class="uk-margin-top">
...
<div class="uk-form-row uk-margin-top">
  <label for="" class="uk-form-label">
    <input type="radio" align="absmiddle" name="geo_type" id="geo_type2" value="2" /><span class="uk-margin-left"><?php echo JText::_('ADAG_GEO_ADD_EXISTING');?></span>
  </label>
  <div class="uk-form-controls">
    <select name="limitation_existing" id="limitation_existing" onchange="fpopulate2();">
    ...
    <div id="existing_container" class="uk-margin-top"></div>
  </div>
</div>
<?php } } ?>
