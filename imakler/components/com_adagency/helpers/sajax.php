...
if (!isset($SAJAX_INCLUDED)) {
	...
	function sajax_get_my_uri() {
		...
		$sajax_remote_uri = str_replace('&controller=adagencyAdvertisers','',$sajax_remote_uri);
		$sajax_remote_uri = str_replace('&task=edit','',$sajax_remote_uri);	
		$sajax_remote_uri = str_replace('&cid[]=0','',$sajax_remote_uri);	
		//$sajax_remote_uri = str_replace('index.php','administrator/index.php',$sajax_remote_uri);	
	...
	function sajax_handle_client_request() {
		...
		$mode = "";
		$rs_get=JRequest::getVar('rs', NULL, 'get');
		$rs_post=JRequest::getVar('rs', NULL, 'post');
		$rsargs_get=JRequest::getVar('rsargs', NULL, 'get');
		$rsargs_post=JRequest::getVar('rsargs', NULL, 'post');
