...
?>
		...
		function alterSize(event) {
			...
			if(((event.keyCode >= 48)&&(event.keyCode <= 57))||((event.keyCode >= 96)&&(event.keyCode <= 105))) {
				ADAG('#affiliate_ad_campaigns').remove();
		...
		function checkZones() {
			var ok = true;
			ADAG('#affiliate_ad_campaigns').find('.adg_row .adg_table_row:gt(0)').each(function(index){
