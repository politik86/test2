...
<div class="ada-ads">
  ...
  <div class="ada-ads-heading">
    <h2 class="ada-ads-title"><?php echo JText::_('AD_TRANSITION'); ?></h2>
  </div>
  ...
  <form class="uk-form uk-form-horizontal" action="index.php" method="post" name="adminForm" id="adminForm">
    <fieldset>
      ...
      <div class="uk-form-row">
        <label for="transition_title" class="uk-form-label">
      ...
      <div class="uk-form-row">
        <label for="transition_description" class="uk-form-label">
      ...
      <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
          <?php echo $editor1->display( 'transitioncode', ''.stripslashes($_row->parameters['ad_code']),'100%', '300px', '20', '60', false); ?>
        </div>
      </div>
      
      <?php if($configs->allow_add_keywords == 1){ ?>
      <div class="uk-form-row">
        ...
        <div class="uk-form-controls">
          ...
          <p class="uk-text-small"><?php echo JText::_("ADAG_ENTER_KEYWORDS"); ?></p>
        </div>
      </div>
      <?php } ?>
