	...
	<div class="row-fluid ">
		<div class="span12">
			...
			//	$Itemid = $helperobj->getitemid('index.php?option=com_content&view=article');
				...
				$terms_link = JUri::root().substr(JRoute::_('index.php?option=com_socialads&view=checkout&layout=updatebill&tmpl=component'),strlen(JUri::base(true))+1);
			?>

			<div class="control-group">

				<a rel="{handler: 'iframe', size: {x: 600, y: 600}}" href="<?php echo $terms_link;?>" class="modal">
				<span class="qtc_terms_conditons hasTip" title="<?php echo JText::_( 'COM_SOCIALADS_UPDATE_BILLING_ADDRESS_TITLE' ); ?>">
