...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			...
			?>
			<span id="btl-panel-login" class="<?php echo $effect;?>"><?php echo JText::_('Giriş');?></span>
			<?php }?>
			<!-- Registration button -->
			<?php
			...
			?>
			<span id="btl-panel-registration" class="<?php echo $effect;?>"><?php echo JText::_('Qeydiyyatdan keç');?></span>
			<?php }
			} ?>
	...
	<div id="btl-content">
		...
		<div id="btl-content-profile" class="btl-content-block">
			...
			<div class="btl-buttonsubmit">
				<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="logoutForm">
					<button name="Submit" class="btl-buttonsubmit" onclick="document.logoutForm.submit();"><?php echo JText::_('Выйти'); ?></button>
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
				...
				<h3><?php echo JText::_('Şəxsi kabinetə giriş') ?></h3>
				<?php if ($enabledRegistration) : ?>
					<div id="register-link">
						<?php echo sprintf(JText::_('Hesabınız yoxdur?'),'<a href="'.JRoute::_('index.php?option=com_users&view=registration').'">','</a>');?>
					</div>
				<?php else: ?>
				...
				<div class="btl-field">
					<div class="btl-label"><?php echo JText::_('Login') ?></div>
					<div class="btl-input">
						<input id="btl-input-username" type="text" name="username"	/>
					</div>
				</div>
				<div class="btl-field">
					<div class="btl-label"><?php echo JText::_('Şifrə') ?></div>
					<div class="btl-input">
				...
				<div class="btl-field">				
					...
					<div class="btl-input" id="btl-input-remember">
						<input id="btl-checkbox-remember"  type="checkbox" name="remember"
							value="yes" />
							<?php echo JText::_('Yadda saxla'); ?>
					</div>	
				</div>
				<div class="clear"></div>
				<?php endif; ?>
				<div class="btl-buttonsubmit">
					<input type="submit" name="Submit" class="btl-buttonsubmit" onclick="return loginAjax()" value="<?php echo JText::_('Giriş') ?>" /> 
					<input type="hidden" name="option" value="com_users" />
			...
			<ul id ="bt_ul">
				<li>
					...
					<?php echo JText::_('Şifrəni unutmuşsunuz'); ?></a>
				</li>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>">
					<?php echo JText::_('Logini unutmuşsunuz'); ?></a>
				</li>				
			</ul>
		...
		<div id="btl-content-registration" class="btl-content-block">			
			...
			<?php if($integrated_com==''){?>	
				...
				<form name="btl-formregistration" class="btl-formregistration"  autocomplete="off">
					...
					<h3><?php echo JText::_('Qeydiyyatdan keç') ?></h3>
					<div id="btl-success"></div>
					<div class="btl-note"><span><?php echo JText::_("Ulduz (*) ile qeyd olunan sahələr doldurulmalıdır"); ?></span></div>
