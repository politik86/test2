...
$helper = new modAdAgencyCPanelHelper();
$adv_param = $helper->getParams($module);
// Get the required itemids
$itemid = $helper->getItemids();
// Run default template script for output
require(JModuleHelper::getLayoutPath('mod_ijoomla_adagency_cpanel'));