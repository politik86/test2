...
class adagencyAdminViewadagencyFloating extends JViewLegacy {
	...
	function editForm($tpl = null) {
		$helper = new adagencyAdminModeladagencyFloating(); 
		global $mainframe;
		...
		JToolBarHelper::title(JText::_('AD_FLOATING').":<small>[".$text."]</small>");
		if ($isNew) {
		...
		//Show Zone select
		//Show available zones for advertiser
