 ...
 */
jQuery(function($){
    ADAG.fn.fcbkcomplete = function(opt){
		return this.each(function(){
            ...
            function addItem(title, value, preadded, locked, focusme){
                ...
                if (!preadded) {
                    ...
                    if (options.onselect.length) {
						var parentTr = holder.children("li.bit-box").parents('tr [id^=limitation]');
                        funCall(options.onselect, parentTr);
                    }
					element.change();
                }
            ...
            function removeItem(item){
               if (!item.hasClass('locked')) {
                    ...
                    if (options.onremove.length) {
						var parentTr = holder.children("li.bit-box").parents('tr [id^=limitation]');
                        funCall(options.onremove, parentTr);
                    }
            ...
            function addInput(focusme){
                ...
                input.attr({
                    "type": "text",
                    "class": "maininput input-zip",
                    "size": "1"
                });
                holder.append(li.append(input));
                
                input.focus(function(){
                    if(holder.find('.maininput').css('display') != 'none') { complete.fadeIn("fast"); }
                });
                ...
                holder.click(function(){
                    ...
                    if (feed.length && input.val().length) {
                        ...
                        feed.hide();
                        browser_msie ? browser_msie_frame.hide() : '';
                        if(holder.find('.maininput').css('display') != 'none') {complete.children(".default").show();}
                    }
                });
